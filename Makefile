...
#    Updated: 2023/04/20 15:56:06 by hsliu            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
val :
	valgrind --log-file="val_log" --tool=memcheck --trace-children=yes --track-fds=yes --track-origins=yes --leak-check=full --show-leak-kinds=all ./miniRT scene_basic.rt
